...
class MultiHeadSelfAttention(nn.Module):
    ...
    def forward(
        ...
        # else:
        #     # for cross-attention, keys and values once and reuse in subsequent calls.
        #     k = kv_cache[self.key]
...
class ResidualSelfAttentionBlock(nn.Module):
    def __init__(self, n_state: int, n_head: int):
        ...
        # self.cross_attn = (
        #     MultiHeadSelfAttention(n_state, n_head) if cross_attention else None
        # )
...
class ResidualCrossAttentionBlock(nn.Module):
    def __init__(self, n_state: int, n_head: int):
        ...
        self.cross_attn = MultiHeadSelfAttention(n_state, n_head)
...
class AudioEncoder(nn.Module):
    def __init__(
        ...
        self.blocks: Iterable[ResidualSelfAttentionBlock] = nn.ModuleList(
            [ResidualSelfAttentionBlock(n_state, n_head) for _ in range(n_layer)]
        )
